...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 21 23:00:33 2021
...
#results = [pool.apply(TLT_LS_func, args=(u, WA_grid_150, OR_grid_150, NCA_grid_150, SCA_grid_150)) for u in datasets]
#results = [TLT_LS_func(u, WA_grid_150, OR_grid_150, NCA_grid_150, SCA_grid_150) for u in datasets]
...
Data_150 = pd.DataFrame([], columns = ST)
for k in range(l[0],l[1]):
    u = datasets[k]
    results = [k,u[0][17:25]]+TLT_LS_func(u, WA_grid_150, OR_grid_150, NCA_grid_150, SCA_grid_150)
    results = np.array(results)
    Data_150 = Data_150.append(pd.Series(results, index=ST), ignore_index=True)
    Data_150.to_csv("data/Data_150_"+str(l[0])+"_to_"+str(l[1])+".csv", )