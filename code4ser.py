...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 22 12:52:04 2021
...
def TLT_LS_CS_250_func(u, WA_grid_250, OR_grid_250, NCA_grid_250, SCA_grid_250):
...
results = [TLT_LS_CS_250_func(u, WA_grid_250, OR_grid_250, NCA_grid_250, SCA_grid_250) for u in datasets]


results = np.array(results)
Data_250 = pd.DataFrame(results, columns = ST)
Data_250.to_csv("Data_250_serial.csv", )