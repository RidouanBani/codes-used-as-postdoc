...
def TLT_LS_CS_func(u, WA_grid, OR_grid, NCA_grid, SCA_grid):
...
results = [TLT_LS_CS_func(u, WA_grid, OR_grid, NCA_grid, SCA_grid) for u in datasets]

results = np.array(results)
CS = pd.DataFrame(results, columns = ST)
CS.to_csv("CS_serial.csv", )